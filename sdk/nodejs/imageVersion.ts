...
export class ImageVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ociregistry:index:ImageVersion';
    ...
    public readonly imageRepo!: pulumi.Output<string>;
    ...
    constructor(name: string, args: ImageVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if ((!args || args.imageRepo === undefined) && !opts.urn) {
                throw new Error("Missing required property 'imageRepo'");
            }
            resourceInputs["constraint"] = args ? args.constraint : undefined;
            resourceInputs["imageRepo"] = args ? args.imageRepo : undefined;
            resourceInputs["imageRef"] = undefined /*out*/;
        } else {
            resourceInputs["constraint"] = undefined /*out*/;
            resourceInputs["imageRef"] = undefined /*out*/;
            resourceInputs["imageRepo"] = undefined /*out*/;
        }
